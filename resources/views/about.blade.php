...
<html lang="en">
  ...
  <body>
    ...
    <nav id="home" class="navbar navbar-expand-lg fixed-top navbar-dark snap-scroll scrolling-navbar" style="background-color: #212121;">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup" name="nav-collapsers" style="color: white;">
          <div class="navbar-nav">
              <a class="btn nav-btn nav-link" href="#features" style="color: white;"> Features </a>
    ...
    <!-- Team -->
    <center>
      <h1 style="margin-top: 9rem; font-weight: bolder;" class="nuevocolor">Información del Usuario</h1>
    </center>
    <div class="container nuevocolorsec" style="margin-top: 5rem; padding-top: 1rem; padding-bottom: 1rem">
      <h1 style="font-weight: 400;">Nombre del usuario:</h1>
      <?php
        use Http\Controllers\UserLogs;
        echo Auth::user()->name;
      ?>
      <h1>Foto de perfil:</h1>
      <img style="width: 100px; height: 100px; border-radius: 50%;" class="h-8 w-8 rounded-full object-cover" src="{{ Auth::user()->profile_photo_url }}" alt="{{ Auth::user()->name }}" />
    </div>
    <center>
      <h1 style="margin-top: 9rem; font-weight: bolder;" class="nuevocolor">About our team</h1>
    </center>
    <section id="team">
      <div class="container text-center text-md-left mt-5 nuevocolorsec" style="margin-bottom: 3.7rem;" >
        <div class="row" style="text-align: center;">
          <div class="col-md-3 mx-auto columna text-black mb-4">
            <img src="./static/img/ghector.jpg" style="width: 100%; padding-top: 2rem; padding-bottom: 1rem"></img>
            <h3 style="font-weight: 500;">Hector Palencia</h3>
            <a href="https://github.com/HectorSkm" class="links" style="font-weight: 400;">Link GitHub</a>
          </div>
          <div class="col-md-3 mx-auto columna text-black">
            ...
            <h3 style="font-weight: 500;">Javier Taborda</h3>
            <a href="https://github.com/RoachLok" class="links" style="font-weight: 400;">Link GitHub</a>
          </div>
          <div class="col-md-3 mx-auto columna text-black">
            <img src="./static/img/garturo.jpg" style="width: 100%; padding-top: 2rem; padding-bottom: 1rem"></img>
            <h3 style="font-weight: 500;">Arturo Alba</h3>
            <a href="https://github.com/ArtySaurio" class="links" style="font-weight: 400;">Link GitHub</a>
          </div>
        </div>
      </div> 
    </section>
