<?php
    ...
    if ($hide == 0) {
        ...
        $db = getDB();
        $st = $db->prepare("SELECT tabid,uname,contentType,content,tabTitle FROM tabs WHERE uname=:username AND contentType='java';");
            ...
            <section class="code-container">
                <span class="sidebar">
                    <ul class="sidebar-nav">
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link" onclick="compileFiles('<?php echo $user."', 'java"; ?>')">
                        ...
                        <li class="sidebar-item">
                            <a href="#" id="composeButton-java" value="c_cpp" class="sidebar-link">
                        ...
                        <li class="sidebar-item">
                            <a href="#" class="sidebar-link" onclick="uploadFiles('<?php echo $user."', 'java"; ?>')">
                ...
                <div class="code-frame">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#iframe1" role="tab" aria-controls="iframe1" aria-selected="true" name="code-tab">New Java.java<button class="close closeTab tab-icon pl-3" type="button">×</button></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#iframe2" role="tab" aria-controls="iframe2" aria-selected="false" name="code-tab">New Java - 2.java<button class="close closeTab tab-icon pl-3" type="button" >×</button></a>
                        </li>
                    </ul>
                    <div class="tab-content code-frame" id="frames-container">
                        <iframe id="iframe1" class="code-frame tab-pane fade show active" role="tabpanel" src="./editor.php?tab&tabId=10&contentType=java" name="test"></iframe>
                        <iframe id="iframe2" class="code-frame tab-pane fade" role="tabpanel" src="./editor.php?tab&tabId=10&contentType=java" name="test"></iframe>
                    </div>
                </div>
            </section>
        </section>
